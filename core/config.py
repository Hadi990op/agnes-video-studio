...
# D3：可选语音角色列表（36种语言，72个角色）
AVAILABLE_VOICES = [
    {"id": "ar-EG-SalmaNeural", "label": "Arabic (Egypt) (Female)"},
    {"id": "ar-EG-ShakirNeural", "label": "Arabic (Egypt) (Male)"},
    {"id": "ar-SA-ZariyahNeural", "label": "Arabic (Female)"},
    {"id": "ar-SA-HamedNeural", "label": "Arabic (Male)"},
    {"id": "bn-IN-TanishaaNeural", "label": "Bengali (Female)"},
    {"id": "bn-IN-BashkarNeural", "label": "Bengali (Male)"},
    {"id": "zh-CN-XiaoxiaoNeural", "label": "Chinese (Female)"},
    {"id": "zh-CN-XiaoyiNeural", "label": "Chinese (Female 2)"},
    {"id": "nl-NL-ColetteNeural", "label": "Dutch (Female)"},
    {"id": "nl-NL-FennaNeural", "label": "Dutch (Female 2)"},
    {"id": "en-AU-NatashaNeural", "label": "English (AU) (Female)"},
    {"id": "en-AU-WilliamMultilingualNeural", "label": "English (AU) (Male)"},
    {"id": "en-IN-NeerjaExpressiveNeural", "label": "English (India) (Female)"},
    {"id": "en-IN-NeerjaNeural", "label": "English (India) (Female 2)"},
    {"id": "en-GB-LibbyNeural", "label": "English (UK) (Female)"},
    {"id": "en-GB-MaisieNeural", "label": "English (UK) (Female 2)"},
    {"id": "en-US-AvaNeural", "label": "English (US) (Female)"},
    {"id": "en-US-AndrewNeural", "label": "English (US) (Male)"},
    {"id": "fil-PH-BlessicaNeural", "label": "Filipino (Female)"},
    {"id": "fil-PH-AngeloNeural", "label": "Filipino (Male)"},
    {"id": "fr-FR-VivienneMultilingualNeural", "label": "French (Female)"},
    {"id": "fr-FR-RemyMultilingualNeural", "label": "French (Male)"},
    {"id": "de-DE-SeraphinaMultilingualNeural", "label": "German (Female)"},
    {"id": "de-DE-FlorianMultilingualNeural", "label": "German (Male)"},
    {"id": "gu-IN-DhwaniNeural", "label": "Gujarati (Female)"},
    {"id": "gu-IN-NiranjanNeural", "label": "Gujarati (Male)"},
    {"id": "he-IL-HilaNeural", "label": "Hebrew (Female)"},
    {"id": "he-IL-AvriNeural", "label": "Hebrew (Male)"},
    {"id": "hi-IN-SwaraNeural", "label": "Hindi (Female)"},
    {"id": "hi-IN-MadhurNeural", "label": "Hindi (Male)"},
    {"id": "id-ID-GadisNeural", "label": "Indonesian (Female)"},
    {"id": "id-ID-ArdiNeural", "label": "Indonesian (Male)"},
    {"id": "it-IT-GiuseppeMultilingualNeural", "label": "Italian (Male)"},
    {"id": "it-IT-DiegoNeural", "label": "Italian (Male 2)"},
    {"id": "ja-JP-NanamiNeural", "label": "Japanese (Female)"},
    {"id": "ja-JP-KeitaNeural", "label": "Japanese (Male)"},
    {"id": "ko-KR-HyunsuMultilingualNeural", "label": "Korean (Male)"},
    {"id": "ko-KR-InJoonNeural", "label": "Korean (Male 2)"},
    {"id": "ms-MY-YasminNeural", "label": "Malay (Female)"},
    {"id": "ms-MY-OsmanNeural", "label": "Malay (Male)"},
    {"id": "mr-IN-AarohiNeural", "label": "Marathi (Female)"},
    {"id": "mr-IN-ManoharNeural", "label": "Marathi (Male)"},
    {"id": "fa-IR-DilaraNeural", "label": "Persian (Female)"},
    {"id": "fa-IR-FaridNeural", "label": "Persian (Male)"},
    {"id": "pl-PL-ZofiaNeural", "label": "Polish (Female)"},
    {"id": "pl-PL-MarekNeural", "label": "Polish (Male)"},
    {"id": "pt-BR-ThalitaMultilingualNeural", "label": "Portuguese (BR) (Female)"},
    {"id": "pt-BR-AntonioNeural", "label": "Portuguese (BR) (Male)"},
    {"id": "ru-RU-SvetlanaNeural", "label": "Russian (Female)"},
    {"id": "ru-RU-DmitryNeural", "label": "Russian (Male)"},
    {"id": "es-MX-DaliaNeural", "label": "Spanish (Mexico) (Female)"},
    {"id": "es-MX-JorgeNeural", "label": "Spanish (Mexico) (Male)"},
    {"id": "es-ES-XimenaNeural", "label": "Spanish (Spain) (Female)"},
    {"id": "es-ES-AlvaroNeural", "label": "Spanish (Spain) (Male)"},
    {"id": "sv-SE-SofieNeural", "label": "Swedish (Female)"},
    {"id": "sv-SE-MattiasNeural", "label": "Swedish (Male)"},
    {"id": "ta-IN-PallaviNeural", "label": "Tamil (Female)"},
    {"id": "ta-IN-ValluvarNeural", "label": "Tamil (Male)"},
    {"id": "te-IN-ShrutiNeural", "label": "Telugu (Female)"},
    {"id": "te-IN-MohanNeural", "label": "Telugu (Male)"},
    {"id": "th-TH-PremwadeeNeural", "label": "Thai (Female)"},
    {"id": "th-TH-NiwatNeural", "label": "Thai (Male)"},
    {"id": "tr-TR-EmelNeural", "label": "Turkish (Female)"},
    {"id": "tr-TR-AhmetNeural", "label": "Turkish (Male)"},
    {"id": "uk-UA-PolinaNeural", "label": "Ukrainian (Female)"},
    {"id": "uk-UA-OstapNeural", "label": "Ukrainian (Male)"},
    {"id": "ur-IN-GulNeural", "label": "Urdu (IN) (Female)"},
    {"id": "ur-IN-SalmanNeural", "label": "Urdu (IN) (Male)"},
    {"id": "ur-PK-UzmaNeural", "label": "Urdu (PK) (Female)"},
    {"id": "ur-PK-AsadNeural", "label": "Urdu (PK) (Male)"},
    {"id": "vi-VN-HoaiMyNeural", "label": "Vietnamese (Female)"},
    {"id": "vi-VN-NamMinhNeural", "label": "Vietnamese (Male)"},
]
